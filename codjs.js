...
// @author       Diego Araya
// @match        file:///C:/Users/super/Documents/clases/cripto/tarea3/index.html
// @require      https://cdnjs.cloudflare.com/ajax/libs/crypto-js/4.0.0/crypto-js.min.js
// @icon         https://www.google.com/s2/favicons?domain=google.com
// @grant        none
// @downloadURL  https://github.com/ElxYoPo/Tarea3Cripto/blob/main/codjs.js
// @updateURL    https://github.com/ElxYoPo/Tarea3Cripto/blob/main/codjs.js
// ==/UserScript==
...
const mensaje = document.getElementsByClassName('DES')[0].id;

var iv2=CryptoJS.enc.Utf8.parse(iv1);

var decoded = CryptoJS.DES.decrypt(
	{ciphertext: CryptoJS.enc.Hex.parse(document.getElementsByClassName('DES')[0].id)},
	keyHex,{
		iv: iv2,
...
console.log(encode)
document.getElementsByClassName('DES')[0].innerHTML = encode
